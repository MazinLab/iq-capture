...
architecture behav of adc_capture is 
    ...
    signal pair_iq_df10_U0_ap_start : STD_LOGIC;
    signal pair_iq_df10_U0_ap_done : STD_LOGIC;
    signal pair_iq_df10_U0_ap_continue : STD_LOGIC;
    signal pair_iq_df10_U0_ap_idle : STD_LOGIC;
    signal pair_iq_df10_U0_ap_ready : STD_LOGIC;
    signal pair_iq_df10_U0_start_out : STD_LOGIC;
    signal pair_iq_df10_U0_start_write : STD_LOGIC;
    signal pair_iq_df10_U0_istream_V_TREADY : STD_LOGIC;
    signal pair_iq_df10_U0_qstream_V_TREADY : STD_LOGIC;
    signal pair_iq_df10_U0_iq_in_din : STD_LOGIC_VECTOR (255 downto 0);
    signal pair_iq_df10_U0_iq_in_write : STD_LOGIC;
    signal pair_iq_df10_U0_capturesize_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal pair_iq_df10_U0_capturesize_out_write : STD_LOGIC;
    signal pair_iq_df10_U0_iqout_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal pair_iq_df10_U0_iqout_out_write : STD_LOGIC;
    ...
    component adc_capture_pair_iq_df10 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component adc_capture_fifo_w256_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    pair_iq_df10_U0 : component adc_capture_pair_iq_df10
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    iq_in_U : component adc_capture_fifo_w256_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    ap_done <= put_data_csize_ap_uint_256_U0_ap_done;
    ap_idle <= (put_data_csize_ap_uint_256_U0_ap_idle and pair_iq_df10_U0_ap_idle);
    ap_ready <= pair_iq_df10_U0_ap_ready;
    ...
    ap_sync_ready <= pair_iq_df10_U0_ap_ready;
    istream_V_TREADY <= pair_iq_df10_U0_istream_V_TREADY;
    pair_iq_df10_U0_ap_continue <= ap_const_logic_1;
    pair_iq_df10_U0_ap_start <= ap_start;
