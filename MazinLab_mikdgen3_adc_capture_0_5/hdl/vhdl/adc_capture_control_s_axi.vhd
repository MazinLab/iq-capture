...
architecture behave of adc_capture_control_s_axi is
    ...
    constant ADDR_CAPTURESIZE_V_DATA_0 : INTEGER := 16#10#;
    constant ADDR_CAPTURESIZE_V_CTRL   : INTEGER := 16#14#;
    constant ADDR_CONFIGURE_DATA_0     : INTEGER := 16#18#;
    constant ADDR_CONFIGURE_CTRL       : INTEGER := 16#1c#;
