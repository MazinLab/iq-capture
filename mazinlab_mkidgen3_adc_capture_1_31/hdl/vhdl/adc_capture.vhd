...
architecture behav of adc_capture is 
    ...
    signal pair_iq_df_flat_U0_ap_start : STD_LOGIC;
    signal pair_iq_df_flat_U0_ap_done : STD_LOGIC;
    signal pair_iq_df_flat_U0_ap_continue : STD_LOGIC;
    signal pair_iq_df_flat_U0_ap_idle : STD_LOGIC;
    signal pair_iq_df_flat_U0_ap_ready : STD_LOGIC;
    signal pair_iq_df_flat_U0_istream_V_TREADY : STD_LOGIC;
    ...
    signal ap_sync_reg_pair_iq_df_flat_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_pair_iq_df_flat_U0_ap_ready : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component adc_capture_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component adc_capture_pair_iq_df_flat IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    entry_proc_U0 : component adc_capture_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    pair_iq_df_flat_U0 : component adc_capture_pair_iq_df_flat
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    iqout_c_channel_U : component adc_capture_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    ap_sync_reg_pair_iq_df_flat_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_pair_iq_df_flat_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_pair_iq_df_flat_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_done <= put_data_csize_ap_uint_256_U0_ap_done;
    ap_idle <= (put_data_csize_ap_uint_256_U0_ap_idle and pair_iq_df_flat_U0_ap_idle and (iqout_c_channel_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle);
    ...
    ap_sync_pair_iq_df_flat_U0_ap_ready <= (pair_iq_df_flat_U0_ap_ready or ap_sync_reg_pair_iq_df_flat_U0_ap_ready);
    ap_sync_ready <= (ap_sync_pair_iq_df_flat_U0_ap_ready and ap_sync_entry_proc_U0_ap_ready);
    entry_proc_U0_ap_continue <= iqout_c_channel_full_n;
    entry_proc_U0_ap_start <= ((ap_sync_reg_entry_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    istream_V_TREADY <= pair_iq_df_flat_U0_istream_V_TREADY;
    pair_iq_df_flat_U0_ap_continue <= ap_const_logic_1;
    pair_iq_df_flat_U0_ap_start <= ((ap_sync_reg_pair_iq_df_flat_U0_ap_ready xor ap_const_logic_1) and ap_start);
