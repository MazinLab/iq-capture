...
void iq_capture(resstream_t &resstream, resstream_t &ddsstream, resstream_t &lpstream, keep_t keep[N_GROUPS], capcount_t capturesize, ap_uint<2> streamselect, iqout_t &iqout);
