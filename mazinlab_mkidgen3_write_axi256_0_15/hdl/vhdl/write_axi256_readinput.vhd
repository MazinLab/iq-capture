...
attribute shreg_extract : string;
    ...
    signal icmp_ln398_1_fu_130_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln398_fu_136_p2 : STD_LOGIC_VECTOR (27 downto 0);
    signal add_ln398_reg_160 : STD_LOGIC_VECTOR (27 downto 0);
    ...
    signal icmp_ln398_fu_147_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_condition_pp0_flush_enable)) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (icmp_ln398_1_fu_130_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (icmp_ln398_1_fu_130_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                indvar_flatten3_reg_97 <= ap_const_lv28_0;
            elsif (((icmp_ln398_fu_147_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln398_1_fu_130_p2, ap_block_pp0_stage0_subdone, ap_condition_pp0_flush_enable)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (icmp_ln398_1_fu_130_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (icmp_ln398_1_fu_130_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln398_fu_136_p2 <= std_logic_vector(unsigned(ap_phi_mux_indvar_flatten3_phi_fu_101_p4) + unsigned(ap_const_lv28_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(iq_in8_full_n, ap_enable_reg_pp0_iter1, stream_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((iq_in8_full_n = ap_const_logic_0) or (stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(iq_in8_full_n, ap_enable_reg_pp0_iter1, stream_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((iq_in8_full_n = ap_const_logic_0) or (stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(iq_in8_full_n, ap_enable_reg_pp0_iter1, stream_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((iq_in8_full_n = ap_const_logic_0) or (stream_TVALID_int_regslice = ap_const_logic_0)));
    end process;
    ...
    ap_block_state3_pp0_stage0_iter1_assign_proc : process(iq_in8_full_n, stream_TVALID_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter1 <= ((iq_in8_full_n = ap_const_logic_0) or (stream_TVALID_int_regslice = ap_const_logic_0));
    end process;


    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln398_fu_147_p2)
    begin
        if (((icmp_ln398_fu_147_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_indvar_flatten3_phi_fu_101_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, indvar_flatten3_reg_97, add_ln398_reg_160, icmp_ln398_fu_147_p2)
    begin
        if (((icmp_ln398_fu_147_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln398_1_fu_130_p2 <= "1" when (tmp_5_fu_118_p3 = ap_const_lv27_0) else "0";
    icmp_ln398_fu_147_p2 <= "1" when (add_ln398_reg_160 = bound_fu_126_p1) else "0";

    iq_in8_blk_n_assign_proc : process(iq_in8_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
