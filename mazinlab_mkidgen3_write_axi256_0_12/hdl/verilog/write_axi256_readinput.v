...
wire   [0:0] icmp_ln397_1_fu_130_p2;
wire   [27:0] add_ln397_fu_136_p2;
reg   [27:0] add_ln397_reg_160;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_pp0_flush_enable)) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln397_1_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln397_1_fu_130_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        indvar_flatten3_reg_97 <= 28'd0;
    end else if (((icmp_ln397_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln397_fu_147_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln397_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (iq_in8_full_n == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        iq_in8_write = 1'b1;
    end else begin
        iq_in8_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            ...
            end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (icmp_ln397_1_fu_130_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln397_fu_136_p2 = (ap_phi_mux_indvar_flatten3_phi_fu_101_p4 + 28'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (stream_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (stream_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (stream_TVALID_int_regslice == 1'b0));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (stream_TVALID_int_regslice == 1'b0);
end
...
assign icmp_ln397_1_fu_130_p2 = ((tmp_5_fu_118_p3 == 27'd0) ? 1'b1 : 1'b0);

assign icmp_ln397_fu_147_p2 = ((add_ln397_reg_160 == bound_fu_126_p1) ? 1'b1 : 1'b0);
