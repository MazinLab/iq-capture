...
architecture behav of filter_iq is 
    ...
    signal p_keep_reg_148_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                p_keep_reg_148_pp0_iter1_reg <= p_keep_reg_148;
                tmp_3_reg_143 <= instream_TUSER_int_regslice;
                tmp_reg_138 <= instream_TDATA_int_regslice;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, p_keep_reg_148, ap_enable_reg_pp0_iter2, p_keep_reg_148_pp0_iter1_reg, regslice_both_outstream_V_data_V_U_apdone_blk, instream_TVALID_int_regslice, outstream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_outstream_V_data_V_U_apdone_blk = ap_const_logic_1) or ((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)))) or ((p_keep_reg_148 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)) or ((ap_const_logic_1 = ap_const_logic_1) and (instream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, p_keep_reg_148, ap_enable_reg_pp0_iter2, p_keep_reg_148_pp0_iter1_reg, ap_block_state2_io, regslice_both_outstream_V_data_V_U_apdone_blk, ap_block_state3_io, instream_TVALID_int_regslice, outstream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_outstream_V_data_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state2_io) or ((p_keep_reg_148 = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_const_logic_1 = ap_const_logic_1) and (instream_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, p_keep_reg_148, ap_enable_reg_pp0_iter2, p_keep_reg_148_pp0_iter1_reg, ap_block_state2_io, regslice_both_outstream_V_data_V_U_apdone_blk, ap_block_state3_io, instream_TVALID_int_regslice, outstream_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and ((regslice_both_outstream_V_data_V_U_apdone_blk = ap_const_logic_1) or (ap_const_boolean_1 = ap_block_state3_io) or ((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((ap_const_boolean_1 = ap_block_state2_io) or ((p_keep_reg_148 = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)))) or ((ap_const_logic_1 = ap_const_logic_1) and (instream_TVALID_int_regslice = ap_const_logic_0)));
    end process;
    ...
    ap_block_state2_io_assign_proc : process(p_keep_reg_148, outstream_TREADY_int_regslice)
    begin
                ap_block_state2_io <= ((p_keep_reg_148 = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(p_keep_reg_148, outstream_TREADY_int_regslice)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((p_keep_reg_148 = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state3_io_assign_proc : process(p_keep_reg_148_pp0_iter1_reg, outstream_TREADY_int_regslice)
    begin
                ap_block_state3_io <= ((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(p_keep_reg_148_pp0_iter1_reg, regslice_both_outstream_V_data_V_U_apdone_blk, outstream_TREADY_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((regslice_both_outstream_V_data_V_U_apdone_blk = ap_const_logic_1) or ((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (outstream_TREADY_int_regslice = ap_const_logic_0)));
    end process;
    ...
    outstream_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, p_keep_reg_148, ap_enable_reg_pp0_iter2, p_keep_reg_148_pp0_iter1_reg, outstream_TREADY_int_regslice)
    begin
        if ((((p_keep_reg_148_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((p_keep_reg_148 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    outstream_TLAST_int_regslice <= "1" when (tmp_3_reg_143 = lastgrp_read_reg_133) else "0";
    outstream_TVALID <= regslice_both_outstream_V_data_V_U_vld_out;

    outstream_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, p_keep_reg_148, ap_block_pp0_stage0_11001)
    begin
