...
architecture behav of write_axi256 is 
    ...
    signal trunc_ln_reg_175 : STD_LOGIC_VECTOR (25 downto 0);
    signal trunc_ln1_reg_181 : STD_LOGIC_VECTOR (58 downto 0);
    signal grp_write_axi256_Pipeline_sync_fu_105_ap_start : STD_LOGIC;
    signal grp_write_axi256_Pipeline_sync_fu_105_ap_done : STD_LOGIC;
    signal grp_write_axi256_Pipeline_sync_fu_105_ap_idle : STD_LOGIC;
    signal grp_write_axi256_Pipeline_sync_fu_105_ap_ready : STD_LOGIC;
    signal grp_write_axi256_Pipeline_sync_fu_105_filtered_TREADY : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_ap_start : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_ap_done : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_ap_idle : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_ap_ready : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWVALID : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WVALID : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WLAST : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARVALID : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_RREADY : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_BREADY : STD_LOGIC;
    signal grp_write_axi256_Pipeline_write_fu_117_filtered_TREADY : STD_LOGIC;
    ...
    signal grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_write_axi256_Pipeline_write_fu_117_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal sext_ln125_fu_153_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln125_fu_170_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal and_ln_fu_163_p3 : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    grp_write_axi256_Pipeline_sync_fu_105 : component write_axi256_write_axi256_Pipeline_sync
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_write_axi256_Pipeline_write_fu_117 : component write_axi256_write_axi256_Pipeline_write
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_write_axi256_Pipeline_sync_fu_105_ap_ready = ap_const_logic_1)) then 
                    grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    grp_write_axi256_Pipeline_write_fu_117_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_write_axi256_Pipeline_write_fu_117_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                    grp_write_axi256_Pipeline_write_fu_117_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_write_axi256_Pipeline_write_fu_117_ap_ready = ap_const_logic_1)) then 
                    grp_write_axi256_Pipeline_write_fu_117_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln1_reg_181 <= out_r(63 downto 5);
                trunc_ln_reg_175 <= capturesize(26 downto 1);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state4, ap_CS_fsm_state11, grp_write_axi256_Pipeline_sync_fu_105_ap_done, grp_write_axi256_Pipeline_write_fu_117_ap_done, gmem_AWREADY, gmem_BVALID, ap_CS_fsm_state3, ap_CS_fsm_state6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (grp_write_axi256_Pipeline_sync_fu_105_ap_done = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state6 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state6) and (grp_write_axi256_Pipeline_write_fu_117_ap_done = ap_const_logic_1))) then
    ...
    and_ln_fu_163_p3 <= (trunc_ln_reg_175 & ap_const_lv1_0);
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_write_axi256_Pipeline_sync_fu_105_ap_done)
    begin
        if ((grp_write_axi256_Pipeline_sync_fu_105_ap_done = ap_const_logic_0)) then 
    ...
    ap_ST_fsm_state6_blk_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_ap_done)
    begin
        if ((grp_write_axi256_Pipeline_write_fu_117_ap_done = ap_const_logic_0)) then 
    ...
    filtered_TREADY_int_regslice_assign_proc : process(grp_write_axi256_Pipeline_sync_fu_105_filtered_TREADY, grp_write_axi256_Pipeline_write_fu_117_filtered_TREADY, ap_CS_fsm_state3, ap_CS_fsm_state6)
    begin
    ...
    gmem_AWADDR_assign_proc : process(ap_CS_fsm_state4, grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWADDR, gmem_AWREADY, ap_CS_fsm_state5, ap_CS_fsm_state6, sext_ln125_fu_153_p1)
    begin
        if (((gmem_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    gmem_AWBURST_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWBURST, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
    ...
    gmem_AWCACHE_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWCACHE, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWID_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWID, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWLEN_assign_proc : process(ap_CS_fsm_state4, grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWLEN, gmem_AWREADY, ap_CS_fsm_state5, ap_CS_fsm_state6, zext_ln125_fu_170_p1)
    begin
        if (((gmem_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    gmem_AWLOCK_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWLOCK, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWPROT_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWPROT, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWQOS_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWQOS, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWREGION_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWREGION, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWSIZE_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWSIZE, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWUSER_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWUSER, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    gmem_AWVALID_assign_proc : process(ap_CS_fsm_state4, grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_AWVALID, gmem_AWREADY, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((gmem_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    gmem_BREADY_assign_proc : process(ap_CS_fsm_state11, grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_BREADY, gmem_BVALID, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((gmem_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state11))) then 
    ...
    gmem_WVALID_assign_proc : process(grp_write_axi256_Pipeline_write_fu_117_m_axi_gmem_WVALID, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    grp_write_axi256_Pipeline_sync_fu_105_ap_start <= grp_write_axi256_Pipeline_sync_fu_105_ap_start_reg;
    grp_write_axi256_Pipeline_write_fu_117_ap_start <= grp_write_axi256_Pipeline_write_fu_117_ap_start_reg;
        sext_ln125_fu_153_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln1_reg_181),64));

    zext_ln125_fu_170_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(and_ln_fu_163_p3),32));
end behav;
