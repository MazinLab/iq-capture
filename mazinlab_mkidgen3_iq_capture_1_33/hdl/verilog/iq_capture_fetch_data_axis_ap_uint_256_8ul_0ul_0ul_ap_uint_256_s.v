...
wire   [35:0] sub_i_i_fu_128_p2;
wire   [0:0] grp_fu_112_p3;
reg   [0:0] p_Result_s_reg_182;
wire   [31:0] i_3_fu_151_p2;
reg   [31:0] i_3_reg_187;
reg   [0:0] p_Result_1_reg_192;
reg    ap_block_state1;
...
wire   [35:0] capturesize_cast_fu_124_p1;
wire  signed [31:0] sext_ln1057_fu_142_p0;
wire  signed [35:0] sext_ln1057_fu_142_p1;
wire  signed [31:0] i_3_fu_151_p0;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_60 <= 32'd0;
    end else if (((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_fu_60 <= i_3_reg_187;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln1057_fu_146_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        p_Result_1_reg_192 <= grp_fu_112_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln1057_fu_146_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_Result_s_reg_182 <= grp_fu_112_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((icmp_ln1057_fu_146_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((icmp_ln1057_fu_146_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)))) begin
...
always @ (*) begin
    ...
    end else if (((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1_01001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if ((((icmp_ln1057_reg_178 == 1'd1) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((icmp_ln1057_fu_146_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln1057_fu_146_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1)) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            end else if (((icmp_ln1057_fu_146_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((fetched_keep18_full_n == 1'b0) | (fetched16_full_n == 1'b0))) | ((icmp_ln1057_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (resstream_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((fetched_keep18_full_n == 1'b0) | (fetched16_full_n == 1'b0))) | ((icmp_ln1057_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (resstream_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & ((fetched_keep18_full_n == 1'b0) | (fetched16_full_n == 1'b0))) | ((icmp_ln1057_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (resstream_TVALID_int_regslice == 1'b0)));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln1057_reg_178 == 1'd1) & (resstream_TVALID_int_regslice == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched_keep18_full_n == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched16_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln1057_reg_178 == 1'd1) & (resstream_TVALID_int_regslice == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched_keep18_full_n == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched16_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = ((ap_enable_reg_pp0_iter0 == 1'b1) & (((icmp_ln1057_reg_178 == 1'd1) & (resstream_TVALID_int_regslice == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched_keep18_full_n == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched16_full_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((icmp_ln1057_fu_146_p2 == 1'd1) & (resstream_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage1_iter0 = (((icmp_ln1057_reg_178 == 1'd1) & (resstream_TVALID_int_regslice == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched_keep18_full_n == 1'b0)) | ((icmp_ln1057_reg_178 == 1'd1) & (fetched16_full_n == 1'b0)));
end
...
assign capturesize_cast_fu_124_p1 = capturesize;

assign fetched16_din = reg_119;

assign grp_fu_112_p3 = keep[resstream_TUSER_int_regslice];

assign i_3_fu_151_p0 = i_fu_60;

assign i_3_fu_151_p2 = ($signed(i_3_fu_151_p0) + $signed(32'd2));

assign icmp_ln1057_fu_146_p2 = (($signed(sext_ln1057_fu_142_p1) < $signed(sub_i_i_fu_128_p2)) ? 1'b1 : 1'b0);

assign resstream_TREADY = regslice_both_resstream_V_data_V_U_ack_in;

assign sext_ln1057_fu_142_p0 = i_fu_60;

assign sext_ln1057_fu_142_p1 = sext_ln1057_fu_142_p0;

assign start_out = real_start;

assign sub_i_i_fu_128_p2 = ($signed(capturesize_cast_fu_124_p1) + $signed(36'd68719476735));
