...
architecture behav of iq_capture is 
    ...
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_idle : STD_LOGIC;
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready : STD_LOGIC;
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_start_out : STD_LOGIC;
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_start_write : STD_LOGIC;
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_resstream_TREADY : STD_LOGIC;
    signal fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_fetched16_din : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal put_data_csize_ap_uint_256_U0_toout17_read : STD_LOGIC;
    ...
    signal ap_sync_reg_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready : STD_LOGIC;
    ...
    component iq_capture_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component iq_capture_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    entry_proc_U0 : component iq_capture_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ap_sync_reg_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_U0_ap_ready <= ap_const_logic_0;
                else 
