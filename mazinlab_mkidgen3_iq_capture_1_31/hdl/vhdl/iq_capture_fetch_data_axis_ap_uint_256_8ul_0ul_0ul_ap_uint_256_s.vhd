...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, total_capturesize_c_full_n, grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((real_start = ap_const_logic_0) or (total_capturesize_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(real_start, ap_done_reg, total_capturesize_c_full_n)
    begin
        if (((real_start = ap_const_logic_0) or (total_capturesize_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) then 
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done)
    begin
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, total_capturesize_c_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (total_capturesize_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_done_reg, grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done, ap_CS_fsm_state3)
    begin
        if (((grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    fetched16_write_assign_proc : process(grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_fetched16_write, ap_CS_fsm_state3)
    begin
    ...
    fetched_keep18_write_assign_proc : process(grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_fetched_keep18_write, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            fetched_keep18_write <= grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_fetched_keep18_write;
        else 
    ...
    internal_ap_ready_assign_proc : process(grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done, ap_CS_fsm_state3)
    begin
        if (((grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    resstream_TREADY_int_regslice_assign_proc : process(grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_resstream_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    total_capturesize_c_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, total_capturesize_c_full_n)
    begin
    ...
    total_capturesize_c_din <= capturesize;

    total_capturesize_c_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, total_capturesize_c_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (total_capturesize_c_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
