...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state9))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1057_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_BVALID == 1'b0))) begin
...
always @ (*) begin
    if ((~((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state9))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln1057_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (*) begin
    if (((icmp_ln1057_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_io))) begin
...
always @ (*) begin
    if ((~((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_BVALID == 1'b0)) & (icmp_ln1057_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln1057_reg_118 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_io))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if (((icmp_ln1057_reg_118 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (1'b0 == ap_block_state2_io))) begin
...
always @ (*) begin
    ap_block_state2_io = ((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_AWREADY == 1'b0));
end

always @ (*) begin
    ap_block_state9 = ((icmp_ln1057_reg_118 == 1'd0) & (m_axi_gmem_BVALID == 1'b0));
end
