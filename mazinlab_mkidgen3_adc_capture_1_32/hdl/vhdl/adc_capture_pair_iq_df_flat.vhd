...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, capturesize_c_full_n, ap_CS_fsm_state2, grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((capturesize_c_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(capturesize_c_full_n)
    begin
        if ((capturesize_c_full_n = ap_const_logic_0)) then 
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done, ap_CS_fsm_state4)
    begin
        if (((grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done, ap_CS_fsm_state4)
    begin
        if (((grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    capturesize_0_ack_out_assign_proc : process(capturesize_c_full_n, ap_CS_fsm_state2, grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done, ap_CS_fsm_state4)
    begin
        if ((((grp_pair_iq_df_flat_Pipeline_read_fu_58_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4)) or ((capturesize_c_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    capturesize_c_blk_n_assign_proc : process(capturesize_c_full_n, ap_CS_fsm_state2)
    begin
    ...
    capturesize_c_din <= capturesize_0_data_reg;

    capturesize_c_write_assign_proc : process(capturesize_c_full_n, ap_CS_fsm_state2)
    begin
        if (((capturesize_c_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    iq_in8_write_assign_proc : process(grp_pair_iq_df_flat_Pipeline_read_fu_58_iq_in8_write, ap_CS_fsm_state4)
    begin
    ...
    istream_V_TREADY_int_regslice_assign_proc : process(grp_pair_iq_df_flat_Pipeline_read_fu_58_istream_V_TREADY, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    qstream_V_TREADY_int_regslice_assign_proc : process(grp_pair_iq_df_flat_Pipeline_read_fu_58_qstream_V_TREADY, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
