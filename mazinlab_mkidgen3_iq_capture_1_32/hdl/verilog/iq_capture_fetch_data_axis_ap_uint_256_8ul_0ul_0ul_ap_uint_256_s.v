...
reg   [34:0] capturesize_0_data_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
#0 capturesize_0_data_reg = 35'd0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((total_capturesize_c_full_n == 1'b0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state4) & (grp_fetch_data_axis_ap_uint_256_8ul_0ul_0ul_ap_uint_256_Pipeline_read_fu_76_ap_done == 1'b1)) | ((1'b1 == ap_CS_fsm_state2) & (total_capturesize_c_full_n == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (total_capturesize_c_full_n == 1'b1))) begin
...
assign total_capturesize_c_din = capturesize_0_data_reg;
