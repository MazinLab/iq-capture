...
reg   [63:0] total_capturesize_0_data_reg;
reg    total_capturesize_0_vld_reg;
reg    total_capturesize_0_ack_out;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 5'd1;
#0 total_capturesize_0_data_reg = 64'd0;
#0 total_capturesize_0_vld_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((iqout_out_full_n == 1'b0) | (capturesize_out_full_n == 1'b0) | (total_capturesize_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln30_fu_165_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((~((1'b1 == ap_CS_fsm_state1) & (real_start == 1'b0)) & (keep_0_ack_out == 1'b1) & (1'b1 == 1'b1) & (keep_0_vld_reg == 1'b1)) | (~((1'b1 == ap_CS_fsm_state1) & (real_start == 1'b0)) & (1'b1 == 1'b1) & (keep_0_vld_reg == 1'b0)))) begin
        keep_0_data_reg <= keep;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln30_fu_165_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((iqout_out_full_n == 1'b0) | (capturesize_out_full_n == 1'b0) | (total_capturesize_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        p_capturesize_V_reg_196 <= p_capturesize_V_fu_161_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((~((1'b1 == ap_CS_fsm_state1) & (real_start == 1'b0)) & (total_capturesize_0_ack_out == 1'b1) & (1'b1 == 1'b1) & (total_capturesize_0_vld_reg == 1'b1)) | (~((1'b1 == ap_CS_fsm_state1) & (real_start == 1'b0)) & (1'b1 == 1'b1) & (total_capturesize_0_vld_reg == 1'b0)))) begin
        total_capturesize_0_data_reg <= total_capturesize;
    end
end

always @ (*) begin
    if ((icmp_ln30_fu_165_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) | (~((iqout_out_full_n == 1'b0) | (capturesize_out_full_n == 1'b0) | (total_capturesize_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln30_reg_215 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln30_reg_215 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln30_fu_165_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state6) | (~((iqout_out_full_n == 1'b0) | (capturesize_out_full_n == 1'b0) | (total_capturesize_out_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2)))) begin
        total_capturesize_0_ack_out = 1'b1;
    end else begin
        total_capturesize_0_ack_out = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((icmp_ln30_fu_165_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((icmp_ln30_fu_165_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((resstream_TVALID_int_regslice == 1'b0) & (icmp_ln30_fu_165_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fetched_keep_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)) | ((fetched_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((resstream_TVALID_int_regslice == 1'b0) & (icmp_ln30_fu_165_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fetched_keep_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)) | ((fetched_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((resstream_TVALID_int_regslice == 1'b0) & (icmp_ln30_fu_165_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fetched_keep_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)) | ((fetched_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)))));
end
...
always @ (*) begin
    ap_block_state2 = ((iqout_out_full_n == 1'b0) | (capturesize_out_full_n == 1'b0) | (total_capturesize_out_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter0 = ((resstream_TVALID_int_regslice == 1'b0) & (icmp_ln30_fu_165_p2 == 1'd0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((fetched_keep_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)) | ((fetched_full_n == 1'b0) & (icmp_ln30_reg_215 == 1'd0)));
end
...
assign fetched_keep_din = p_Result_s_reg_201;

assign icmp_ln30_fu_165_p2 = ((i_reg_150 == p_capturesize_V_reg_196) ? 1'b1 : 1'b0);

assign iqout_out_din = iqout_0_data_reg;

assign p_Result_s_fu_184_p3 = keep_0_data_reg[resstream_TUSER_int_regslice];

assign p_capturesize_V_fu_161_p1 = total_capturesize_0_data_reg[34:0];

assign resstream_TREADY = regslice_both_resstream_V_data_V_U_ack_in;

assign start_out = real_start;

assign total_capturesize_out_din = total_capturesize_0_data_reg;
