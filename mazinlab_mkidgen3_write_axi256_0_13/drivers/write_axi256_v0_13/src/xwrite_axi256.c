...
void XWrite_axi256_Set_out_r(XWrite_axi256 *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XWrite_axi256_WriteReg(InstancePtr->Control_BaseAddress, XWRITE_AXI256_CONTROL_ADDR_OUT_R_DATA, (u32)(Data));
    XWrite_axi256_WriteReg(InstancePtr->Control_BaseAddress, XWRITE_AXI256_CONTROL_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XWrite_axi256_Get_out_r(XWrite_axi256 *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XWrite_axi256_ReadReg(InstancePtr->Control_BaseAddress, XWRITE_AXI256_CONTROL_ADDR_OUT_R_DATA);
    Data += (u64)XWrite_axi256_ReadReg(InstancePtr->Control_BaseAddress, XWRITE_AXI256_CONTROL_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
