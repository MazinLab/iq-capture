...
architecture behave of iq_capture_control_s_axi is
    ...
    signal int_total_capturesize : UNSIGNED(63 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_TOTAL_CAPTURESIZE_DATA_1 =>
                        rdata_data <= RESIZE(int_total_capturesize(63 downto 32), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TOTAL_CAPTURESIZE_DATA_1) then
                    int_total_capturesize(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_total_capturesize(63 downto 32));
                end if;
            end if;
        end if;
    end process;
