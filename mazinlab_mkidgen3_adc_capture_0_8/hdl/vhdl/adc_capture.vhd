...
architecture behav of adc_capture is 
    ...
    signal pair_iq_df_flat7_U0_ap_start : STD_LOGIC;
    signal pair_iq_df_flat7_U0_ap_done : STD_LOGIC;
    signal pair_iq_df_flat7_U0_ap_continue : STD_LOGIC;
    signal pair_iq_df_flat7_U0_ap_idle : STD_LOGIC;
    signal pair_iq_df_flat7_U0_ap_ready : STD_LOGIC;
    signal pair_iq_df_flat7_U0_start_out : STD_LOGIC;
    signal pair_iq_df_flat7_U0_start_write : STD_LOGIC;
    signal pair_iq_df_flat7_U0_istream_V_TREADY : STD_LOGIC;
    signal pair_iq_df_flat7_U0_qstream_V_TREADY : STD_LOGIC;
    signal pair_iq_df_flat7_U0_iq_in_din : STD_LOGIC_VECTOR (255 downto 0);
    signal pair_iq_df_flat7_U0_iq_in_write : STD_LOGIC;
    signal pair_iq_df_flat7_U0_capturesize_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal pair_iq_df_flat7_U0_capturesize_out_write : STD_LOGIC;
    signal pair_iq_df_flat7_U0_iqout_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal pair_iq_df_flat7_U0_iqout_out_write : STD_LOGIC;
    ...
    signal put_data_csize_ap_uint_256_U0_iq_in_read : STD_LOGIC;
    ...
    component adc_capture_pair_iq_df_flat7 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component adc_capture_put_data_csize_ap_uint_256_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component adc_capture_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component adc_capture_fifo_w64_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component adc_capture_start_for_put_data_csize_ap_uint_256_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component adc_capture_gmem_m_axi IS
    generic (
...
begin
    control_s_axi_U : component adc_capture_control_s_axi
    generic map (
    ...
    gmem_m_axi_U : component adc_capture_gmem_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 256,
        USER_AW => 64,
    ...
    pair_iq_df_flat7_U0 : component adc_capture_pair_iq_df_flat7
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    capturesize_c_U : component adc_capture_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    iqout_c_U : component adc_capture_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_put_data_csize_ap_uint_256_U0_U : component adc_capture_start_for_put_data_csize_ap_uint_256_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= put_data_csize_ap_uint_256_U0_ap_done;
    ap_idle <= (put_data_csize_ap_uint_256_U0_ap_idle and pair_iq_df_flat7_U0_ap_idle);
    ap_ready <= pair_iq_df_flat7_U0_ap_ready;
    ...
    ap_sync_ready <= pair_iq_df_flat7_U0_ap_ready;
    istream_V_TREADY <= pair_iq_df_flat7_U0_istream_V_TREADY;
    pair_iq_df_flat7_U0_ap_continue <= ap_const_logic_1;
    pair_iq_df_flat7_U0_ap_start <= ap_start;
