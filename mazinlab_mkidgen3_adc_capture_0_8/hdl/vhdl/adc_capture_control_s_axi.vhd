...
entity adc_capture_control_s_axi is
generic (
...
end entity adc_capture_control_s_axi;
...
architecture behave of adc_capture_control_s_axi is
    ...
    constant ADDR_CAPTURESIZE_DATA_0 : INTEGER := 16#10#;
    constant ADDR_CAPTURESIZE_CTRL   : INTEGER := 16#14#;
    constant ADDR_IQOUT_DATA_0       : INTEGER := 16#18#;
    constant ADDR_IQOUT_DATA_1       : INTEGER := 16#1c#;
    constant ADDR_IQOUT_CTRL         : INTEGER := 16#20#;
    ...
    signal int_capturesize     : UNSIGNED(31 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CAPTURESIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_capturesize(31 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CAPTURESIZE_DATA_0) then
                    int_capturesize(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_capturesize(31 downto 0));
                end if;
            end if;
        end if;
    end process;
